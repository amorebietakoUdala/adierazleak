 ...
 */
final class Version20220113104650 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE indicator (id INT AUTO_INCREMENT NOT NULL, description_es VARCHAR(1024) NOT NULL, description_eu VARCHAR(1024) NOT NULL, required_roles JSON DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
